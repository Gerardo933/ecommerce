...
var btnList = $(".btnList");
//cuantas cajas de lista me esta trayendo utilizando su longitd, cuantos grid hay
for(var i = 0; i < btnList.length; i++){

	$("#btnGrid"+i).click(function(){
		//this= a lo que le estoy dando click, le capturaremos su atributo id y le extraemos el ultimo digito, osea solo 1
		//esto funciona con todos los grid
		var numero = $(this).attr("id").substr(-1);

		$(".list"+numero).hide();
		$(".grid"+numero).show();
		//colorar el boton cuando le da a grid o lista
		$("#btnGrid"+numero).addClass("backColor1");
		$("#btnList"+numero).removeClass("backColor2");
	...
	$("#btnList"+i).click(function(){
		...
		$("#btnGrid"+numero).removeClass("backColor1");
		$("#btnList"+numero).addClass("backColor2");
